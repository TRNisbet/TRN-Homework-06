...
function displayCityWeather(event) {
    ...
    var queryURL = 'https://api.openweathermap.org/data/2.5/weather?q=' + city + '&units=imperial&appid=42a2523861d86792568f5a170e814f50';
...
function displayCityUv() {
    var lat = cityLat;
    var lon = cityLon;
    var queryURL = 'https://api.openweathermap.org/data/2.5/uvi?lat=' + lat + '&lon=' + lon + '&appid=42a2523861d86792568f5a170e814f50';
...
function displayCityForecast() {
    var queryURL = 'https://api.openweathermap.org/data/2.5/forecast?q=' + city + '&units=imperial&appid=42a2523861d86792568f5a170e814f50';
    $('.forecastCards').empty()
    ...
    $.ajax({
        ...
        var iconUrl = 'https://openweathermap.org/img/w/' + iconCode + '.png';
        $('.forecastCards').append('<button type="button" class="forecast btn btn-primary"><h5>' + forecastDate1 + '</h5><img src="'
            + iconUrl + '"><p>Temp: ' + responseForecast.list[7].main.temp + ' °F</p><p>Humidity: ' + responseForecast.list[7].main.humidity +
            '%</p></button>');

        var iconCode = responseForecast.list[15].weather[0].icon;
        var iconUrl = 'https://openweathermap.org/img/w/' + iconCode + '.png';
        $('.forecastCards').append('<button type="button" class="forecast btn btn-primary"><h5>'
            + forecastDate2 + '</h5><img src="' + iconUrl + '"><p>Temp: ' + responseForecast.list[15].main.temp + ' °F</p><p>Humidity: '
            + responseForecast.list[15].main.humidity + '%</p></button>');

        var iconCode = responseForecast.list[23].weather[0].icon;
        var iconUrl = 'https://openweathermap.org/img/w/' + iconCode + '.png';
        $('.forecastCards').append('<button type="button" class="forecast btn btn-primary"><h5>'
            + forecastDate3 + '</h5><img src="' + iconUrl + '"><p>Temp: ' + responseForecast.list[23].main.temp +' °F</p><p>Humidity: '
            + responseForecast.list[23].main.humidity + '%</p></button>');

        var iconCode = responseForecast.list[31].weather[0].icon;
        var iconUrl = 'http://openweathermap.org/img/w/' + iconCode + '.png';
        $('.forecastCards').append('<button type="button" class="forecast btn btn-primary"><h5>'
            + forecastDate4 +'</h5><img src="' + iconUrl +'"><p>Temp: '+ responseForecast.list[31].main.temp +' °F</p><p>Humidity: '
            + responseForecast.list[31].main.humidity +'%</p></button>');

        var iconCode = responseForecast.list[39].weather[0].icon;
        var iconUrl = 'https://openweathermap.org/img/w/' + iconCode + '.png';
        $('.forecastCards').append('<button type="button" class="forecast btn btn-primary"><h5>'+ forecastDate5 +'</h5><img src="' 
        + iconUrl +'"><p>Temp: '+ responseForecast.list[39].main.temp + ' °F</p><p>Humidity: ' 
        + responseForecast.list[39].main.humidity +'%</p></button>');
